...
//     console.log(el)
    ...
    // //querySelector
    // value= document.querySelector('.card-header');//queray selector select single element and take first
